    ...
    return (
        <div className="h-screen w-screen flex items-center justify-center bg-[#EFEFEF]">
            <div className="flex w-[337px] md:w-[414px] flex-col p-2.5">
                <div className="bg-[#FFFFFF] flex-1 flex flex-col gap-3 p-8 rounded-xl shadow-sm place-items-start">
                    ...
                    <div className="flex flex-col w-full flex-1 gap-2.5">
                        <input className="border w-full border-[#D1D5DB] p-3 focus:outline-none rounded-lg" type="password" placeholder="Password" />
                    </div>
                    ...
                    <div className="flex flex-row gap-2.5 justify-end items-end flex-1">
                        <p className="text-[#1A73E8] text-[14px] underline">forgot password?</p>
                    </div>
                </div>
                <button className="py-4 px-3.5 bg-[#1A73E8] w-full rounded-[10px] text-white font-semibold hover:cursor-pointer">
                    Sign in
                </button>
